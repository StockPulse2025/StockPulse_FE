...
class StockDetailChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxY = candleData.map((d) => d['high'] as double).reduce((a, b) => a > b ? a : b) * 1.02;
    final minY = candleData.map((d) => d['low'] as double).reduce((a, b) => a < b ? a : b) * 0.98;
                  ...
                  barRods: [
                    BarChartRodData(
                      ...
                      rodStackItems: [
                        ...
                        BarChartRodStackItem(data['close'], data['high'], Colors.transparent),
                      ],
